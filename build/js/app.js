...
var Container = function (_React$Component) {
    ...
    function Container(props) {
        ...
        _this.MenuClickSetState = function (page) {
            _this.setState({
                title: page,
        ...
        _this.handleMenuClick = function (page) {
            switch (page) {
                case "AboutMe":
                    _this.MenuClickSetState(page);
                    break;
                case "Projects":
                    _this.MenuClickSetState(page);
                    break;
        ...
        _this.generateMenuList = function () {
            return _this.state.titlesArray.map(function (page) {
                return _react2.default.createElement(
                    "li",
                    { className: "mobile-menu-list-position", key: page, onClick: function onClick() {
                            _this.handleMenuClick(page);
                        } },
                    page
                );
            });
        ...
        _this.handleInput = function (screen, title) {
            _this.setState({
        ...
        _this.handleMenuDisplay = function () {
            switch (_this.state.menuDisplay) {
                case "display-none":
                    _this.setState({
    ...
    _createClass(Container, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    "ul",
                    { className: "mobile-menu-list", id: this.state.menuDisplay },
                    this.generateMenuList()
                ),
                _react2.default.createElement(_content2.default, { renderScreen: this.state.title }),
...
var Terminal = function (_React$Component) {
    ...
    function Terminal(props) {
        ...
        _this.handleTerminalTitle = function (input) {
            switch (input) {
                case "cd AboutMe":
                    return "AboutMe";
                    break;
        ...
        _this.handleInfoTransfer = function (e) {
            if (e.keyCode === 13) {
                if (typeof _this.props.renderInfo === "function") {
                    _this.props.renderInfo(_this.state.renderScreen, _this.handleTerminalTitle(_this.state.renderScreen));
                    _this.displayText();
                    _this.setState({
                        renderScreen: ""
                    });
        ...
        _this.displayFiles = function (currentPage) {
            var files = ["AboutMe", "Projects", "PersonalInfo"];
            switch (currentPage) {
                case "AboutMe":
                    return _react2.default.createElement(
                        "div",
        ...
        _this.setCommand = function (command) {
            _this.setState({
                listOfCommands: [].concat(_toConsumableArray(_this.state.listOfCommands), ["mateusz-kowalski:" + _this.props.titleText + " " + command])
            });
        };

        _this.displayText = function () {
            var command = _this.state.renderScreen;
            switch (command) {
                case "cd AboutMe":
                ...
                case "ls":
                    _this.setState({
                        listOfCommands: [].concat(_toConsumableArray(_this.state.listOfCommands), [_this.displayFiles(_this.props.titleText)])
                    });
                    break;
                default:
                    if (_this.state.renderScreen.indexOf("cd") === -1) {
                        _this.setState({
                            listOfCommands: [].concat(_toConsumableArray(_this.state.listOfCommands), ["-bash:" + _this.state.renderScreen + ": command not found"])
                        });
                    } else {
                        _this.setState({
                            listOfCommands: [].concat(_toConsumableArray(_this.state.listOfCommands), ["-bash: cd:" + _this.state.renderScreen.substring("cd".length) + " no such file or directory"])
                        });
                    }
            }
        };
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        " ",
                        _react2.default.createElement("input", { placeholder: "type here...", type: "text", value: this.state.renderScreen, onChange: this.handleChange, onKeyUp: function onKeyUp(e) {
...
var Content = function (_React$Component) {
    ...
    function Content() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Content.__proto__ || Object.getPrototypeOf(Content)).call.apply(_ref, [this].concat(args))), _this), _this.handleRender = function (renderScreen) {
            switch (renderScreen) {
                case "AboutMe":
