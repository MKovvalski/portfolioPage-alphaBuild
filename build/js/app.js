...
var Content = function (_React$Component) {
    ...
    function Content(props) {
        ...
        _this.handleMenuClick = function (page) {
            if (typeof _this.props.MenuClick === "function") {
                _this.props.MenuClick(page);
            }
            _this.setState({
                menuDisplay: "none"
            });
            ...
            return _this.state.titlesArray.map(function (page) {
                return _react2.default.createElement(
                    ...
                    { className: "mobile-menu-list-position", key: page, onClick: function onClick() {
                            return _this.handleMenuClick(page);
                        } },
                    page
                );
            });
        ...
        _this.handleRender = function (renderScreen) {
            switch (renderScreen) {
                case "AboutMe":
